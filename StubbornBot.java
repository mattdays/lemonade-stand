...
/**
 * A Lemonade Stand game player that is extremely attached to the idea of being
 * difficult.
 * 
 * @author MD, BR
 */
public class StubbornBot implements Bot {
    ...
    public int getNextMove(int player1LastMove, int player2LastMove) {
        ...
        if (this.roundCount > 0) {
            ...
            utility = scoreRound(this.historyP0.get(this.historyP0.size() - 1),
                    this.historyP1.get(this.historyP1.size() - 1), this.historyP2.get(this.historyP2.size() - 1));
            // this.utilityHistory.add(utility);
